...
- 2026-07-24: full suite GREEN: 889 tests (2 PostgreSQL-only skips), including raw legacy updater bootstrap; migration, compile, manifest JSON, and diff checks GREEN.
