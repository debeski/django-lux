...
class MicrosysAuthorizationView(AuthorizationView or View):
    """DOT authorization endpoint wrapper that applies Microsys SSO client policy."""

    def dispatch(self, request, *args, **kwargs):
        if AuthorizationView is None or get_application_model is None:
            raise ImproperlyConfigured("django-oauth-toolkit is required by django-microsys-sso")
