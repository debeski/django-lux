    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("application", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="dlux_sso_policy", to="oauth2_provider.application")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("policy", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="dlux_sso.ssoclientpolicy")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_by", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="+", to=settings.AUTH_USER_MODEL)),
                ("policy", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="admin_invitations", to="dlux_sso.ssoclientpolicy")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("created_by", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="+", to=settings.AUTH_USER_MODEL)),
                ("policy", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="memberships", to="dlux_sso.ssoclientpolicy")),
