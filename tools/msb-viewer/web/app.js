...
const TOKEN = document.querySelector('meta[name="msb-token"]').content;
...
async function api(path, opts = {}) {
  const headers = Object.assign({ "X-MSB-Token": TOKEN }, opts.headers || {});
...
function renderUnlockMeta() {
  ...
  add("Microsys version", META.microsys_version || "—");
...
function renderOverview(c) {
  ...
  add("Microsys version", SUMMARY.microsys_version || META.microsys_version || "—");
  const enc = META.encryption || {};
