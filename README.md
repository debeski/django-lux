...
Customize branding, default theme, default languages, and translation overrides directly from the **App Options** UI for Superusers. On a fresh install, superusers are guided through a dedicated first-launch setup wizard at `/sys/setup/`, and the same settings remain editable afterward from the Options modal.
