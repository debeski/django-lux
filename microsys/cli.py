...
def main(argv=None):
    parser = argparse.ArgumentParser(
        prog="ms",
        description="MicroSys project and app scaffolding",
    )
    subparsers = parser.add_subparsers(dest="command")

    startproject_parser = subparsers.add_parser(
        "startproject",
        help="Create a new MicroSys-ready Django project",
    )
    ...
    startapp_parser = subparsers.add_parser(
        "startapp",
        help="Create a new MicroSys-native app in the current project",
    )
