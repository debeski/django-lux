...
MICROSYS_STRINGS = {
    ...
    'ar': {
        ...
        'user_report_subtitle': 'ملخص شامل لما يحتفظ به Microsys عن هذا المستخدم داخل المشروع الحالي.',
        ...
        'sysbackup_subtitle': 'نسخة كاملة مشفرة لكل بيانات وملفات النظام (.msb) مع إمكانية الاستعادة الكاملة.',
        ...
        'sysbackup_orphans_hint': 'ملفات .msb موجودة في مجلد النسخ الاحتياطي ولم تُنشأ من هذه الصفحة. يمكن الاستعادة منها مباشرة.',
        'sysbackup_no_orphans': 'لا توجد ملفات خارجية.',
        'sysbackup_upload': 'رفع ملف نسخة',
        'sysbackup_upload_invalid': 'الملف المرفوع ليس ملف نسخة احتياطية صالحاً (.msb).',
    ...
    'en': {
        ...
        'help_sys_titlebar_logo_treatment': 'Choose how Microsys visually assists the logo on mixed theme surfaces.',
        ...
        'user_report_subtitle': 'A consolidated summary of what Microsys knows about this user in the current project.',
        ...
        'sysbackup_subtitle': 'Complete encrypted snapshot of all system data and files (.msb) with full restore.',
        ...
        'sysbackup_orphans_hint': '.msb files found in the backup folder that were not created from this page. They can be restored directly.',
        'sysbackup_no_orphans': 'No external files found.',
        'sysbackup_upload': 'Upload Backup File',
        'sysbackup_upload_invalid': 'The uploaded file is not a valid backup (.msb) file.',
