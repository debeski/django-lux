    ...
    function getTutorialSteps() {
        ...
        // 3. User Management (`/sys/users/`)
            ...
            steps = [
                ...
                { element: 'button[data-dynamic-modal]', popover: { title: t.users_add_btn_title || 'Add User', description: t.users_add_btn_desc || 'Add new user.', side: "bottom", align: 'end' }},
    ...
    if (!document.getElementById('driver-rtl-fix')) {
        ...
        style.innerHTML = `
            ...
            .tut-btn {
                ...
                border-radius: 50px;
                padding: 8px 20px;
                font-family: var(--ms-main-font, var(--ms-font-fallback, sans-serif));
                font-size: 0.95rem;
                cursor: pointer;
                transition: all 0.2s;
                font-weight: bold;
