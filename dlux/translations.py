...
DLUX_STRINGS = {
    ...
    'ar': {
        ...
        'system_setup_step11': 'الخطوة 11: الملف الشخصي',
        ...
        'help_sys_public_root_theme': 'السمة المطبَّقة على الجذر العام للزوار غير المسجّلين. اتركها على الافتراضي لوراثة السمة المعتادة.',
        'form_sys_public_root_title': 'عنوان صفحة الجذر العام',
        'help_sys_public_root_title': 'عنوان صفحة اختياري يظهر للزوار غير المسجّلين على الجذر العام. اتركه فارغاً لاستخدام اسم النظام.',
        'form_sys_public_root_meta_description': 'وصف ميتا للجذر العام',
        'help_sys_public_root_meta_description': 'وصف ميتا اختياري يُضاف على الجذر العام لمحركات البحث ومعاينات الروابط.',
        'form_sys_show_titlebar_on_public': 'إظهار الشريط العلوي في الجذر العام',
        'help_sys_show_titlebar_on_public': 'إظهار الشريط العلوي للزوار غير المسجّلين على الجذر العام. مخفي افتراضياً.',
        'form_sys_show_sidebar_on_public': 'إظهار الشريط الجانبي في الجذر العام',
        'help_sys_show_sidebar_on_public': 'إظهار الشريط الجانبي للزوار غير المسجّلين على الجذر العام. مخفي افتراضياً.',
        ...
        'navbar_root_default_option': 'الجذر الافتراضي',
        ...
        'form_sys_public_root_split_enabled': 'فصل الصفحة الرئيسية للمستخدم غير المسجّل عن رابط الصفحة الرئيسية الافتراضي',
        ...
        'composer_deployer_version': 'Composer (المُنصِّب)',
