...
DLUX_STRINGS = {
    ...
    'ar': {
        ...
        'system_setup_step9': 'الخطوة 9: الالوان',
        'system_setup_step10': 'الخطوة 10: المظهر',
        'system_setup_step11': 'الخطوة 11: السجلّات',
        ...
        'help_sys_purge_session_on_exit': 'إنهاء الجلسة عند إغلاق التبويب أو المتصفح بدلاً من إبقاء المستخدم مسجّل الدخول في زيارته التالية.',
    ...
    'en': {
        ...
        'system_setup_step10': 'Step 10: Layout',
        'system_setup_step11': 'Step 11: Logging',
        ...
        'help_sys_purge_session_on_exit': 'End the session when the tab or browser is closed instead of keeping the user signed in on their next visit.',
