...
(function () {
    const STORAGE_PREFIX = 'dluxFilterAdvanced:';
    ...
    function write(key, value) {
        try {
            ...
            // Private-browsing quota failures must not break the filter.
        }
    }
    ...
    function init() {
        ...
        document.querySelectorAll('button.dlux-filter-toggle[data-bs-target]').forEach(function (toggle) {
