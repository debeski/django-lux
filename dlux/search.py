...
SETTINGS_SECTIONS = (
    ...
    (4, 'system_settings_login_page', 'bi-box-arrow-in-right',
     ('login page', 'hero', 'banner', 'login style', 'split', 'centered')),
    (5, 'system_settings_sidebar', 'bi-layout-sidebar-inset',
     ('sidebar', 'menu', 'navigation', 'collapse', 'side nav')),
    (6, 'system_settings_navbar', 'bi-signpost-split',
     ('navbar', 'nav bar', 'breadcrumb', 'hierarchy')),
    (7, 'system_settings_titlebar', 'bi-window-stack',
     ('titlebar', 'title bar', 'global search', 'search', 'user hub', 'actions')),
    (8, 'system_settings_notifications', 'bi-bell-fill',
     ('notification', 'flash', 'toast', 'drawer', 'alerts')),
    (9, 'system_settings_appearance', 'bi-brush',
     ('theme', 'appearance', 'font', 'typography', 'color', 'dark mode')),
    (10, 'system_settings_layout', 'bi-grid-1x2-fill',
    ...
    (11, 'system_settings_logging', 'bi-journal-text',
     ('logging', 'activity log', 'audit', 'retention')),
    (12, 'system_settings_profile', 'bi-person-badge',
     ('profile', 'avatar', 'profile page')),
    (13, 'system_settings_backups', 'bi-safe2-fill',
