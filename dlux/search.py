...
SETTINGS_SECTIONS = (
    ...
    (6, 'system_settings_titlebar', 'bi-window-stack',
    ...
    (9, 'system_settings_layout', 'bi-grid-1x2-fill',
    ...
    (10, 'system_settings_logging', 'bi-journal-text',
     ('logging', 'activity log', 'audit', 'retention')),
    (11, 'system_settings_profile', 'bi-person-badge',
     ('profile', 'avatar', 'profile page')),
    (12, 'system_settings_backups', 'bi-safe2-fill',
