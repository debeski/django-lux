...
grep — `force_password_change` in particular was a private helper inside the
system-options views, reachable only through its view.

The views stay in :mod:`dlux.views.options`; this package holds the logic they
