...
urlpatterns = [
    ...
    path('sys/settings/preview/draft/', views.system_settings_preview_draft_view, name='system_settings_preview_draft'),
    path('sys/settings/preview/modal-content/', views.system_settings_preview_sample_modal_view, name='system_settings_preview_sample_modal'),
    path('sys/settings/preview/sample/<str:kind>/', views.system_settings_preview_sample_view, name='system_settings_preview_sample'),
    ...
    path('sys/backup/restore/status/', views.system_restore_list_status_view, name='system_restore_list_status'),
    ...
    path('sys/api/dlux-update/interval/', views.dlux_update_interval_view, name='dlux_update_interval'),
    path('sys/api/dlux-ops/state/', views.dlux_ops_state_view, name='dlux_ops_state'),
    path('sys/api/dlux-ops/run/', views.dlux_ops_run_view, name='dlux_ops_run'),
